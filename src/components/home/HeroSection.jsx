...
const HeroSection = () => {
  return (
    <div className="sm:hight900:h-full  sm:hightUt900:h-screen h-full bg-[#1E014B] sm:bg-gradient-to-r from-[#100028] to-[#220058] flex flex-col w-full relative  overflow-hidden justify-between">
      {/* main section */}

...
const FreeTrail = () => {
  ...
  return (
    <div className="flex h-full sm:flex-row flex-col relative z-[10] sm:overflow-visible overflow-hidden">
      ...
      <div className="lg:py-24 sm:bg-[#6019CE]  flex lg:px-20 sm:px-16 px-8 py-20 flex-col z-20 2xl:pl-[150px] sm:pl-[40px] w-full">
        <h1 className="font-semibold 2xl:text-5xl lg:text-4xl sm:text-3xl text-4xl text-white leading-10">
          What if <br className="sm:hidden block"/> <span className="text-[#FF5E3A]">I don’t like it?</span>
        </h1>
          <h2 className="text-[#FFE600] font-semibold 2xl:text-4xl lg:text-3xl sm:text-2xl text-2xl mt-[14px] font-nunito tracking-[-2%] ">
            7 Day Free Trial
          </h2>

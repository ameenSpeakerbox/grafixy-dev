      ...
      <div className="w-full lg:pt-[312px] sm:pt-36 pt-11  bg-[#1A0143] flex flex-col 2xl:pl-[147px] lg:py-[140px] sm:px-[80px] px-8   h-full py-[120px]">
        ...
        <div className="grid w-full 2xl:gap-24 lg:gap-20 sm:gap-16 gap-14">
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                Grafixy likes to serve clients around the Globe. Our team works
                remotely and gets your design works done wherever you are at
                your convenience.
              </p>
            }
          />
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                Our Grafixy team will work on 2 tasks in progress for you in our
                working time and they will allocate 8 Hours in each business day
                to complete your requests
                <br />
                <br />
                Now if you have more tasks to complete in short time, you can
                add additional Grafixy subscriptions <br /> As our team
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                <br />
                You can reach us out from every Monday to Saturday via mail and
                chat.
              </p>
            }
          />
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                Project manager reviews your requests and assigns them to these
                designers. When a request is completed, we then move on to your
                next request. <br />
                If the priority of your requests is to be changed, you can let
                your project manager know. They will undertake the requests as
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                Grafixy is for Startups, SME”s, marketers, Creative agencies,
                freelancers, entrepreneurs - who need cost-effective, high
                graphic design services. With us, you will feel like you have an
                in-house designer with a convenient budget.
              </p>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                Grafixy’s unlimited graphic design service includes unlimited
                requests and unlimited revisions. This means that you can make
                many requests as you would like and we will work to give the
                best design. Once you submit your requests, your dedicated
                project manager will review and ensure that we have all the
                necessary details before assigning it to the team. <br />
                When a request is completed, we then move on to your next
                request. <br />
                If the priority of your requests is to be changed, you can let
                your project manager know. They will undertake the requests as
                per your convenience. <br />
                We work on your requests on a first in first out basis. These
                requests will be there in the designers stack in the order that
                they received. Designing team then works on delivering them.{" "}
                <br />
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                offering unlimited graphic design services. Through us, anyone
                who needs help with design can work with a dedicated Design Team
                to make and manage all of their design projects in one place.{" "}
                <br /> This service is offered for a flat fee on a month to
                month basis making custom designs in an affordable and flexible
                way. We serve clients from Saudi Arabia, UAE and India.
              </p>
            }
          />
          <TypoFAQ
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                You will have the rights to all the designs created by grafixy
                for you during your paid subscription. <br />
                If you would like to resell any of the designs, please be sure
                to let your Project Manager know when making your design
                request. Your team will then create your design from scratch, so
                that you have full rights to sell your design. <br />
                For all of your other design requests, where you'll be the
                end-user, and you will not be reselling your design, your team
                will either create the design from scratch and/or use stock
                elements or photos, as needed to meet the requirements of your
                brief. Just remember, we double-check every element and stock
                photo we use, to make sure you’re granted the licences to use
                them as the end-user. And we are assuming materials you provide
                to us are licensed and owned by you. If you do happen to send
                grafixy unlicensed materials to use, remember we are not held
                liable for the rights of the final design.
              </p>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                At grafixy we aim to keep things simple. That's why we have one
                graphic design subscription - grafixy Graphics - and one video
                design subscription - grafixy Video. And one subscription which
                combines both - grafixy Graphics+Video. <br />
                Whichever subscription you choose, start with a free trial and
                invite as many team members as you'd like to help you make
                design requests. You won't pay any extra premiums for custom
                illustrations, landing pages, or GIFs with a grafixy Graphics
                subscription. And no extra fees for custom design and animation
                with a grafixy Video subscription. <br />
                You get it all with your flat monthly fee. <br />
                <br />
                Will there be any hidden fees? There are no hidden fees at all.
                You will only pay the flat fee on a monthly basis. All taxes and
                other fees are included in the flat fee.
              </p>
            }
          />
          <TypoFAQ
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                documentation or extensive process. You can cancel at any point
                in time. Just log in to your grafixy account, and you can cancel
                with just a few clicks. Need a hand with this? No worries. You
                can request assistance via the live chat at www.grafixy.io. You
                can also request assistance from your dedicated Project Manager.
                There is only one thing that we will ask: “What could we have
                done better?” We ask, because we value your feedback. Just need
                a temporary break? But still want access to your Trello board,
                to remain assigned to the same dedicated design team, and to
                lock in the existing subscription price regardless of service
                updates? Consider{" "}
                <a
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                Yes, you can! We get it. Workflows change and you don't always
                need to have an active subscription. But at the same time, you
                might still need access to your Trello board. <br />
                And if you've gotten into a really good groove with your design
                team, you may want to make sure that they're still going to be
                matched with them when you resume your subscription. <br />
                To address all of this we've introduced the "Pause Your
                Subscription" feature for a flat monthly fee of $18.99. This
                allows you to pause your account as of the end of the current
                subscription period so that there is no auto-renewal. And it
                allows you to enjoy these benefits: <br />
                <ul>
                  <li>
                    Securing your current subscription fee, regardless of any
                    changes to grafixy pricing.
                  </li>
                  <li>
                    Having ongoing access to your Trello board, and all of your
                    design files.
                  </li>
                  <li>
                  ...
                  <li>
                    Making the most of your subscription by resuming when you
                    have more design requests.
                  </li>
                </ul>
                ...
                and submit a request. To request to resume your subscription,
                log into your account and submit a request.
              </p>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                <ul>
                  ...
                  <li>
                    Booklets (limited to 2-3 pages during the trial, depending
                    on the amount of content)
                  </li>
                  <li>
                    Brand Mascot or Brand Character Designs (not included during
                    the trial)
                  </li>
                  <li>Brochures</li>
                  ...
                  <li> Display Ads</li>
                  <li>
                    Ebooks (limited to 2-3 pages during the trial, depending on
                  ...
                  <li>
                    Presentation Decks (limited to 2-3 slides during the trial,
                    depending on the amount of content)
                  </li>
                  <li>Print Ads</li>
                  ...
                  <li>Web Ads</li>
                  <li>
                    And just about anything that can be designed in PS, AI, or
                    INDD.
                  </li>
                </ul>
              </p>
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                Absolutely. If you require more than one subscription to keep up
                with all your design needs, you can add additional subscriptions
                at any time. And you can also cancel them at any time, which
                means you can scale up, or down quickly. <br />
                With each additional subscription that you add, you'll increase
                the number of outputs you receive, and the speed at which you
                receive them. <br />
                For example, one additional subscription will double the designs
                you get completed each business day. <br />
                To learn more about adding additional subscriptions, reach out
                to us on the live chat at www.grafixy.io, 7 days a week! Or to
                add an additional subscription, log in to your account at
                www.grafixy.io.
              </p>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                $200 USD per month, for grafixy Graphics; $500 USD per month for
                grafixy Video; <br /> No set-up fee, no minimum terms, no
                cancellation penalties. Absolutely no contracts.
              </p>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                <ul>
                  ...
                  <li>
                    An Activity Feed where you can see all of the activity that
                    has taken place on your board
                  </li>
                </ul>
                New Requests: <br />
                ...
                attachments. <br />
                grafixy Tip: Refer to the “Resources” list to help you figure
                out which details to include. <br />
                Prioritizing Your Requests: <br /> When you’re making multiple
                requests, be sure to order your cards according to priority.
                Requests are fulfilled on a first-come, first-served basis, from
                the top down. So, if you’re posting multiple requests at the
                same time, make sure the order of your cards reflects which
                tasks should be completed first. <br /> Revision Requests <br />{" "}
                ...
                <ul>
                  ...
                  <li>
                    ...
                    "Requests" list. The sooner you do this, the sooner we work
                    on your revision request.
                  </li>
                </ul>
                Adding Brand Guidelines <br />
                You can add your brand guidelines to the "Guidelines" list to
                make the design process more efficient. Add a new card for each
                brand you will be requesting designs for. And be sure to include
                as many details as possible (logos, color palettes, style guides
                or style references, inspiration images, and designs). We want
                to know it all!
              </p>
            }
          />
              ...
              <p>
                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <li>Bleed size (you can confirm this with your printer)</li>
                    <li>
                ...
                possible, triple check your text copy, and provide pictures as
                references of the style you’d like. <br /> <br /> How To Access
                Your Files <br /> Your completed design files are all available
                in the “Completed” list on your Trello board. To find what
                you’re looking for quickly, use the search bar at the top of
                your board. <br />
                Or they'll be in your inbox if you've chosen to use grafixy with
                email. If you require your designs in a particular format, be
                sure to let your grafixy team know!
              </p>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                <ul>
                  ...
                  <li>
                    Specify the size of the bleed (we’ll include the standard
                  ...
                  <li>Include any references for business cards you like</li>
                </ul>
                What should I do if my team is having trouble understanding my
                ideas? <br />
                We offer unlimited revisions because we want you to get exactly
                what you need. But, at times, there can be a disconnect between
                what you imagine and what you get. If you find yourself in that
                spot, here’s what we recommend:
                <ul>
                  <li>
                    Review your requests: Sometimes a request is missing details
                    or not as clear as it could be. Try providing additional
                    references and details in your revision requests.
                  </li>
                  <li>
                    Give your designer detailed feedback: Let your designer
                    clearly know what they’ve missed. They’ll work as quickly as
                    possible to have your design revised.
                  </li>
                </ul>
                grafixy Tip: After attempting steps 1 and 2, if you find that
                your design is still falling short, shoot us an email at
                support@grafixy.io. We’ll review the issue and work to find you
          ...
          <TypoFAQ
            ...
            ans={
              <ul>
                ...
                <li>
                  Specify the size of the design (inches, centimetres or pixels)
                </li>
                <li>Specify the orientation – vertical or horizontal</li>
                <li>
                  Text copy (headline, call-to-action, contact information,
                ...
                <li>Tell us what to avoid</li>
                <li>Describe your industry and target audience</li>
                <li>Include any references for flyers or posters you like</li>
              </ul>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                <ul>
                  ...
                  <li>
                    grafixy Tip:** Be sure to specify the page number for each
                    set of content.
                  </li>
                  <li>Tell us the style you’d like, e.g.</li>
                  <li>Tell us your preferences for color and font</li>
                ...
                grafixy Tip: Add a card to the “Guidelines” list with the brand
                guidelines for each brand you’d like us to design for. Be sure
                to mention the brand when making a request. We'll take care of
                the rest.
              </p>
            }
          />
            ...
            ans={
              <ul>
                ...
                <li>
                  ...
                  Tip:** If you don’t know the size, just send us the link to
                  your blog and we’ll design according to your layout.
                </li>
                <li>Text copy</li>
                <li>Tell us the style you’d like, e.g.</li>
                <li>Traditional or Modern</li>
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                completely removed, made transparent, or to retain a specific
                colour. <br />
          ...
          <TypoFAQ
            ...
            ans={
              <ul>
                ...
                <li>Tell us your industry and target audience</li>
                <li>
                  Include any references for banners you like (attachments or
                  links)
                </li>
              </ul>
            }
            ...
            ans={
              <ul>
                ...
                <li>
                  ...
                  pixels). If you have a previous design or template available,
                  attach it!
                </li>
                <li>
                  Text copy (headline, call-to-action, contact information,
                ...
                <li>Tell us what to avoid</li>
                <li>Describe your industry and target audience</li>
                <li>Include any references for packaging & labels you like</li>
                <li>
                  Tell us the style you’d like, e.g.
                  <ul>
                    <li>Traditional or Modern</li>
          ...
          <TypoFAQ
            ...
            ans={
              <ul>
                ...
                <li>Tell us what to avoid</li>
                <li>Describe your industry and target audience</li>
                <li>Include any references for email signatures you like</li>
              </ul>
            }
          />
          <TypoFAQ
            ...
            ans={
              <ul>
                <li>
                  Describe what you’re looking for (what type of banner would
                  you like designed?)
                </li>
                <li>
                  Attach your brand assets (logo, pictures, elements etc.)
                ...
                <li>Tell us what to avoid</li>
                <li>Describe your industry and target audience</li>
                <li>Include any references for tradeshow banners you like</li>
                <li>
                  Tell us the style you’d like, e.g.{" "}
                  <ul>
                    <li>-Traditional or Modern</li>
            ...
            ans={
              <p>
                ...
                <ul>
                  ...
                  <li>
                    2. Provide the text copy in a format we can copy and paste
                    from. You can do this by including it in the description,
                    attach a word doc or provide the link to a Google doc.
                  </li>
                </ul>
              </p>
            }
          ...
          <TypoFAQ
            ...
            ans={
              <ul>
                <li>Describe what you’re looking for</li>
                <li>
                  Attach your brand assets (logo, pictures, author’s picture,
                  elements etc.)
                </li>
                ...
                <li>Specify the orientation – vertical or horizontal</li>
                <li>
                  Text copy (e.g. title, author’s name, brief intro/blurb for
                  the back cover)
                </li>
                <li>
                  Tell us the style you’d like, e.g.{" "}
          ...
          <TypoFAQ
            ...
            ans={
              <ul>
                ...
                <li>
                  Specify the size of the bleed (if your request is for print)
                </li>
                <li>
                  Text copy (headline, call-to-action, contact information,
                  etc.)
          ...
          <TypoFAQ
            ...
            ans={
              <ul>
                ...
                <li>
                  Attach your brand assets (logo, pictures, author’s picture,
                  elements etc.) - anything you'd like on your podcast cover.
                </li>
                <li>Confirm if your design is for a print or e-book</li>
                <li>
                  Specify the size of the design (pixels) grafixy Tip: Podcast
                  feeds require artwork that is a minimum size of 1400 x 1400
                  pixels and a maximum size of 3000 x 3000 pixels. We recommend
                  designing at 3000 x 3000 pixels. This way you won't have to
                  resize later on.
                </li>
                <li>Text copy (e.g. title, author’s name, tagline, etc.)</li>
                <li>
                  Tell us the style you’d like, e.g.{" "}
                  <ul>
                    <li>-Traditional or Modern</li>
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                On Trello: br Comment, drag, and drop. Just add the details of
                the revision required in a comment. Then move the relevant card
                from the “In Review” or "Completed" list to the “Requests” list.{" "}
                <br />
                On Email: <br />
          ...
          <TypoFAQ
            ...
            ans={
              <p>
                ...
                Requests are fulfilled on a first-come, first-served basis, from
                the top down on Trello. So, if you’re posting multiple requests
                at the same time, make sure the order of your cards reflects
                which tasks should be completed first. <br />
                Via email please be sure to mention if a particular task is a
                priority.
              </p>
            }
          />
            ...
            ans={
              <p>
                <ul>
                  ...
                  <li>
                    Attach pictures to be used, references, logos and/or assets.
                  </li>
                </ul>
                grafixy Tip: If you’ll need your designer to select the pictures
                for your design, be sure to give them points of reference or a
                description of what you’re looking for. Need help with making
                your request? Refer to our request guidelines. <br />
                <br />
                Inviting Team Members To View Your Board <br />
                Work as part of a team and need to give others access to your
                designs? You've got it. <br />
                Just let us know your team members' preferred emails or their
                existing Trello usernames, if they already use Trello. We'll
                then invite them to help you make and manage design requests.
              </p>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                Pausing a request is easy. Simply comment on the relevant card
                to let your designer know that the request should be paused
                until you confirm. <br />
                Cancelling a request is simple too. If you need to cancel a
                request, just comment on the relevant card to let your designer
                know that the request should be cancelled.
              </p>
            }
          />
          <TypoFAQ
            ...
            ans={
              <p>
                You can set up notifications for individual tasks by opening the
                relevant card and selecting “watch”. <br />
                If you’d like to set up notifications for an entire list, simply
                click on the 3 dots beside the list name and select “watch”.{" "}
                <br />
                ...
                <ul>
                  ...
                  <li>
                    Attachments uploaded to a card (or all cards in a list if
                    you've turned on notifications for a list)
                  </li>
                </ul>
                grafixy Tip: Click on the bell icon, at the top right corner of
                your board to control the frequency of your notification emails
                and to turn on/off desktop notifications.
              </p>
            }
          />
          <TypoFAQ
